...
const PokeCardId = ({pokemon}) => {
  ...
  return (
    ...
    <section className="idPage__container1">
        <header className={`idPage__header ${pokemon?.types[0].type.name}-gradient`}>
          <img
        ...
        <article className="idPage__containerIdNumber">
          ...
          <h1 className={'idPage__idNumber ${pokemon?.types[0].type.name}-color'}>#{pokemon?.id}</h1>
        </article>
        <article className="idPage__id">
          <h2 className={`idPage__name ${pokemon?.types[0].type.name}-color`}>{pokemon?.name}</h2>
        </article>
    ...
    {/**<h4>Hp</h4>
            <div className="idPage__stats-div">
              <div className="porcen COL">150</div>
            </div>
            <h4>Stroke</h4>
            <div className="idPage__stats-div">
              <div className="porcen COL">150</div>
    ...
    <section className="idPage__moves">
       ...
       {pokemon?.moves.slice(0,25).map((moveInfo)=>(
        <span className="idPage__moves-span" key={moveInfo.move.url}>{moveInfo.move.name}</span>
    ...
    {/** <p className="idPage__moves-span">
