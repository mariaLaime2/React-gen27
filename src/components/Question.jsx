  ...
  return (
    <div>
      {activeResults ? (
        ...
        <div className="flex flex-col justify-between shadow-md shadow-slate-300 w-500 min-w-350 h-[600px] ml-2 mr-2 mt-10 mb-10 border border-solid p-10 rounded-lg ">
          <div className="flex justify-between">
            <span className="text-xl font-bold">
              {/**numero de pregunta actuaal numero de preguntas totales */}
          ...
          <button
            className="px-5 py-2 rounded-lg font-bold transition-all hover:bg-yellow-500 hover:text-gray-900"
            onClick={onReset}
          >
            Reiniciar
          </button>
          ...
          {/** las resppuestas aqui*/}
          <div className="grid grid-cols-2 gap-5">
            {/**mapeamos un arreglo de respuesta correcta y respuestas incorrecats */}
