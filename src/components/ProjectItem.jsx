...
const ProjectItem = ({ img, url, title, urlG }) => {
  return (
    <div className="relative flex items-center justify-center h-auto w-full  rounded-xl group hover:bg-gradient-to-r from-gray-200 to-[#540b98] ">
